...
train_df = pd.read_csv("match_data_train_0825.csv")
valid_df = pd.read_csv("match_data_val_0825.csv")
...
model.summary() # Total Params : 59,995
model.compile(loss="categorical_crossentropy", metrics=["accuracy"])
model.fit(x_train, y_train,epochs=20, verbose=1, validation_data=(x_valid,y_valid), callbacks=[TensorB])
